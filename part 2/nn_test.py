...
class TestNeuralNetwork(unittest.TestCase):
    ...
    def test_minibatch_gradient(self):
        ...
        w1 = 0.1 * np.random.uniform(0.0, 1.0, (5, 64))
        b1 = np.zeros(64)

        w2 = 0.1 * np.random.uniform(0.0, 1.0, (64, 64))
        b2 = np.zeros(64)

        w3 = 0.1 * np.random.uniform(0.0, 1.0, (64, 64))
        b3 = np.zeros(64)
        w4 = 0.1 * np.random.uniform(0.0, 1.0, (64, 3))
        b4 = np.zeros(3)
